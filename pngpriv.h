...
#ifndef PNGPRIV_H
#  define PNGPRIV_H
// UNITY-specific: we use lump build, so this will not work as intended
// UNITY-specific: we keep #ifndef PNGPRIV_H around whole file (new pnglib has it just here)
// #else
...
#endif /* PNG_VERSION_INFO_ONLY */
// UNITY-specific: see above, we use lump builds so we cannot have pngpriv inclusion check as written
#endif /* PNGPRIV_H */
// END UNITY-specific
